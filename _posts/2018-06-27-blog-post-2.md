...
* Do we have any level of certainty the parameter is in all important one interval we actually computed?
...
___So are confidence intervals useless?___

Sometimes, but we can also use our imagination to envision one possible scenario where confidence intervals can play an important and meaninful role. Let's pretend you are a member of a government regulatory agency tasked with regularly assessing the value of a paremeter and making regulatory decisions based on your assessment. Perhaps you're a member of the EPA examining toxicity levels or estimating maximum sustainable fish harvest levels to regulate the fishing industry. If you base your analysis on a correctly produced 95% frequentist style confidence intervals, you can confidently say you are "right" in your assessment about 95% of the time in the long run. So in the context of repeatedly making decisions, you have theory-based assurances that you are getting it right about 95% of the time.
