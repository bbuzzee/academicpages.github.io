...
One solution, and the one taught in virtually every introductory statistics class in the United States, is the frequentist-style confidence interval. Confidence intervals were originally developed by Jerzy Neyman in his 1937 paper "Outline of a Theory of Statistical Estimation Based on the Classical Theory of Probability." This is the same Jerzy Neyman that worked with Egon Pearson over the course of the previous several years to develop the theory behind frequentist style hypothesis testing. $^4$ 
...
of containing the true value of theta (Neyman, 1937).$^5$
